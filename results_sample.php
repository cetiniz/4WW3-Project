...
<?php 
	...
	$query = $_POST["query"];
	$results = $pdo->query("SELECT equipment_owner, equipment_location, equipment_name, equipment_department,equipment_id FROM object_equipment WHERE equipment_name LIKE '%" . $query .  "%'");
?>
